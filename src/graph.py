...
if IS_LANGGRAPH:
    ...
    DB_URI = os.getenv("DB_URI") or os.getenv("DATABASE_URL_UNPOOLED") or os.getenv("DATABASE_URL")
    if not DB_URI:
        raise ValueError("DB_URI is not configured. Please set your Neon database URI in the .env file.")
